                        ...
                        <ul class="nav">
                            ...
                            <li>
                                ...
                                <div id="subPages" class="collapse ">
                                    <ul class="nav">
                                        <li><a href="batchclass.jsp" class=""><i class="lnr lnr-home"></i> <span>Batch Class</span></a></li>
                                        <li><a href="errorbank.jsp" class=""><i class="lnr lnr-code"></i> <span>Error Bank</span></a></li>
                                        <li><a href="errorbank.jsp" class=""><i class="lnr lnr-chart-bars"></i> <span>Evaluation</span></a></li>
                                        <li><a href="participant.jsp" class=""><i class="lnr lnr-cog"></i> <span>Participant</span></a></li>
                                        <li><a href="report.jsp" class=""><i class="lnr lnr-cog"></i> <span>Report</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li>
