    ...
    <body>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="../ScoreServlet?idEva=<%= data.getId()%>&action=select">
                                                    ...
                                                    <select class="form-control" id="cbAspect" name="cbAspect">
                                                        <%
                                                            if (!isAspectListEmpty) {
                                                                for (Aspect dataA : (List<Aspect>) session.getAttribute("dataAspect")) {
                                                        %>
        ...
        <script>
            function ScoreEdit(id, aspect, rating, eva) {
                ...
                document.getElementById('hdIdEva').value = eva
            }
        </script>
        <script>
