                ...
                <div class="sidebar-scroll">
                    <nav>
                        <ul class="nav">
                            ...
                            <li><a href="../IdCardServlet" class=""><i class="lnr lnr-alarm"></i> <span>Id Card</span></a></li>
                            <li><a href="../EmployeeLockerServlet" class=""><i class="lnr lnr-alarm"></i> <span>Employee Locker</span></a></li>
                            <li><a href="../EmployeeAccessServlet" class=""><i class="lnr lnr-alarm"></i> <span>Emplloyee Access</span></a></li>
                            <li><a href="../PlacementServlet" class=""><i class="lnr lnr-alarm"></i> <span>Placement</span></a></li>
<!--                            <li>
